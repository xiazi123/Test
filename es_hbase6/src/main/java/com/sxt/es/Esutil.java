...
public class Esutil {
		...
		public static  Client getClient() {
			...
			try {
				client = TransportClient.builder().settings(settings).build()
						.addTransportAddress(new InetSocketTransportAddress(InetAddress.getByName("h153"), 9300))
						.addTransportAddress(new InetSocketTransportAddress(InetAddress.getByName("h154"), 9300))
						.addTransportAddress(new InetSocketTransportAddress(InetAddress.getByName("h155"), 9300));
	...
	public static Map<String, Object> search(String key,String index,String type,int start,int row){
		...
		builder.addHighlightedField("author");
